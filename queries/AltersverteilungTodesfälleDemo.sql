SELECT DATE(A.Timestamp) AS Datum, TIME(A.Timestamp) AS Uhrzeit, A.Anzahl AS "<5", B.Anzahl AS "5-14", C.Anzahl AS "15-24", D.Anzahl AS "25-34", E.Anzahl AS "35-44", F.Anzahl AS "45-54", G.Anzahl AS "55-64", H.Anzahl AS "65-74", I.Anzahl AS "75-84", J.Anzahl AS ">85" FROM AltersverteilungTodesfälleDemo A
